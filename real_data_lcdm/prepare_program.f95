...
! get length of file
OPEN(50,file='prepare/fi_regions.txt')
io_err=0
n_fg=0
DO WHILE (io_err==0) 
...
! get length of file
OPEN(50,file='prepare/cluster_fp_distances_SDSS_m.txt')
io_err=0
n_fp=0
DO WHILE (io_err==0) 
READ(50,*,iostat=io_err) 
...
OPEN(50,file='prepare/fi_regions.txt')
 DO i=1,n_fg
READ(50,*) dummy_var,dummy_var,dummy_var,px(i),py(i),pz(i),mass(i),dummy_var,rad(i),dummy_var
END DO
 CLOSE(50)
...
OPEN(50,file='prepare/position_data.txt')
DO i=1,n_fp
IF (z_clustercore(i)<0.1D0) THEN
WRITE(50,*)  ra_clustercore(i),dec_clustercore(i)
END IF
END DO
 CLOSE(50)
...
OPEN(50,file='input/fg_model.txt')
 DO i=1,n_fg
...
END DO
 ...
 OPEN(50,file='input/ts_data.txt')
 DO i=1,n_fp
IF (z_clustercore(i)<0.1D0) THEN
