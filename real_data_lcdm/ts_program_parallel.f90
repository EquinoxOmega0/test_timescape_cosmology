...
OPEN (51,file='input/fg_model.txt')
io_err=0
n_fg=0
DO WHILE (io_err==0) 
...
!write output
OPEN(50,file='output/results.txt')
DO i=1,n 
...
OPEN(50,file='output/result_map.txt')
DO i=0,200
DO ii=0,200
...
OPEN(50,file='output/result_map_wighted.txt')
DO i=0,200
DO ii=0,200
help_x2=(DBLE(i)/200.D0)
help_y2=(DBLE(ii)/100.D0)
...
OPEN(50,file='output/full_results.txt')
DO i=1,n 
