...
! get length of file
OPEN(50,file='../dark_catalogues/fi_dark/fi_regions_truefullmass_'//TRIM(mockstr)//'.txt')
io_err=0
n_fg=0
DO WHILE (io_err==0) 
...
! get length of file
OPEN(50,file='../sim_LCDM/prepare/mock_catalogues/catalogues/cluster_fp_distances_exact_SDSS_'//TRIM(mockstr)//'.txt')
io_err=0
n_fp=0
DO WHILE (io_err==0) 
READ(50,*,iostat=io_err) 
...
OPEN(50,file='../dark_catalogues/fi_dark/fi_regions_truefullmass_'//TRIM(mockstr)//'.txt')
 DO i=1,n_fg
READ(50,*) px(i),py(i),pz(i),mass(i),rad(i)
END DO
 CLOSE(50)
 ...
 OPEN(50,file='../sim_LCDM/prepare/mock_catalogues/catalogues/cluster_fp_distances_exact_SDSS_'//TRIM(mockstr)//'.txt')
 DO i=1,n_fp
 READ(50,*) cluster_id(i),ra_clustercore(i),dec_clustercore(i),z_clustercore(i),&
 cluster_fp_adist_m(i),cluster_fp_cdist_m(i),cluster_fp_ldist_m(i),&
 cluster_z_adist_m(i),cluster_z_cdist_m(i),cluster_z_ldist_m(i),&
